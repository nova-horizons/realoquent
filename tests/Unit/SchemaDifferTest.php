...
it('can detect new table', function () {
    ...
    $newArray['admins'] = [
        ...
        'columns' => [
            'id' => [
                'type' => \NovaHorizons\Realoquent\Enums\Type::bigIncrements,
                'cast' => 'integer',
                'guarded' => true,
            ],
        ],
...
it('can detect new column with inferred index', function () {
    ...
    expect($changes['index_new']['users.users_birthdate_index']->columns)->toBe(['birthdate']);
});
...
it('can detect updated explicit index', function () {
    ...
    expect($changes['index_updated']['users.users_id_username_index']['changes']['isUnique']['new'])->toBeTrue();
    expect($changes['index_updated']['users.users_id_username_index']['changes']['isUnique']['old'])->toBeFalse();
